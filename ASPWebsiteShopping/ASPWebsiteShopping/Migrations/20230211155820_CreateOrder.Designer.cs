...
namespace ASPWebsiteShopping.Migrations
{
    ...
    [Migration("20230211155820_CreateOrder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPWebsiteShopping.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASPWebsiteShopping.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASPWebsiteShopping.Models.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("ASPWebsiteShopping.Models.Order", b =>
                {
                    b.HasOne("ASPWebsiteShopping.Models.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ASPWebsiteShopping.Models.OrderItem", b =>
                {
                    b.HasOne("ASPWebsiteShopping.Models.Order", "Order")
                        .WithMany("OrderItems")
